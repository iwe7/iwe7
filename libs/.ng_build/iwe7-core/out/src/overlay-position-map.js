 ...
 */
export const /** @type {?} */ POSITION_MAP = /** @type {?} */ ((/** @type {?} */ ({
    top: {
        originX: 'center',
        originY: 'top',
        overlayX: 'center',
...
export const /** @type {?} */ DEFAULT_4_POSITIONS = _objectValues([
    POSITION_MAP["top"],
    POSITION_MAP["right"],
    POSITION_MAP["bottom"],
    POSITION_MAP["left"]
]);
export const /** @type {?} */ DEFAULT_DROPDOWN_POSITIONS = _objectValues([
...
export const /** @type {?} */ DEFAULT_MENTION_POSITIONS = /** @type {?} */ ([
    POSITION_MAP["bottomLeft"],
    {
        originX: 'start',
        originY: 'bottom',
