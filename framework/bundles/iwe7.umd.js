(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/router'), require('rxjs'), require('rxjs/operators'), require('rxjs/observable/fromPromise'), require('underscore'), require('rxjs/observable/fromEvent'), require('iwe7/lazy-load'), require('iwe7-core')) :
	typeof define === 'function' && define.amd ? define('iwe7', ['exports', '@angular/core', '@angular/common', '@angular/router', 'rxjs', 'rxjs/operators', 'rxjs/observable/fromPromise', 'underscore', 'rxjs/observable/fromEvent', 'iwe7/lazy-load', 'iwe7-core'], factory) :
	(factory((global.iwe7 = {}),global.ng.core,global.ng.common,global.ng.router,global.rxjs,global.Rx.Observable.prototype,global.Rx.Observable,global.underscore,global.Rx.Observable,global.iwe7['lazy-load'],global.iwe7Core));
}(this, (function (exports,core,common,router,rxjs,operators,fromPromise,underscore,fromEvent,lazyLoad,iwe7Core) { 'use strict';
...
LazyLoaderService$1.ngInjectableDef = core.defineInjectable({ factory: function LazyLoaderService_Factory() { return new LazyLoaderService$1(core.inject(core.NgModuleFactoryLoader), core.inject(core.NgModuleRef), core.inject(LAZY_COMPONENTS)); }, token: LazyLoaderService$1, providedIn: "root" });
...
exports.LazyLoaderService = LazyLoaderService$1;
